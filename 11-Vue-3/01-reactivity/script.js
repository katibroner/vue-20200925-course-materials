import { reactive, computed, watchEffect, watch, ref, toRefs, toRaw } from './vue3.esm-browser.js';
...
watchEffect(() => {
  ...
  console.log("Items (toRefs -> value):", Object.values(toRefs(state.items)).map(refItem => refItem.value));
